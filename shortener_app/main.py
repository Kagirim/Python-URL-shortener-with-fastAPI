...
# connect to the engine and create the tables
...
# Catch error when a url does not exist in db
def raise_not_found(request):
    message = f"URL '{request.url}' doesnt exist"
    raise HTTPException(status_code=404, detail=message)


# Catch error when user attempts undefined actions
...
@app.get("/")
def read_root():
    return "Welcome to teh URL shortener API :"
